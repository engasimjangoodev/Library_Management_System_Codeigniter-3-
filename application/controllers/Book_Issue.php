...
class Book_Issue extends CI_Controller
{
	...
	{
		$data['content'] = $this->load->view('issue_book_form', '', true);
	...
	{
		$data['content'] = $this->load->view('book_issue_list', '', true);
		$this->load->view('template', $data);
	}
	...
	function show_issue_book()
	{
		...
		$data = $this->Book_Issue_model->issue_book_list();
	...
	function book_list_id()
	{
		...
		$data = $this->Book_Issue_model->book_list_id($book_id);
...
//		$this->form_validation->set_rules('cover_file', 'Please Select Cover File', 'required');
	...
	public function get_Book_Members_List()
	{
		...
		$data["members"] = $this->Book_Issue_model->get_Members();
		$data["books"] = $this->Book_Issue_model->get_Books();
	...
	public function get_Book_data_By_ID()
	{
		$book_id = $this->input->post("book_id");
		$data = $this->Book_Issue_model->get_Book_data_By_ID($book_id);

		echo json_encode($data);
	}
	public function get_Members_data_By_ID()
	{
		$id = $this->input->post("id");
		$data = $this->Book_Issue_model->get_Members_data_By_ID($id);
