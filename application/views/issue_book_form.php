...
<div class="col-md-6">
	<div class="card mt-5 ">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<button type="button" class="btn btn-info btn-sm"><i class="fas fa-arrow-alt-circle-right"></i>
				</button>
			...
			<div class="row">
			<div class="col-md-12">
				<button type="submit" class="btn btn-success"><i class="fas fa-arrow-alt-circle-right"></i> Make
					this issue
				</button>
...
<script type="application/javascript">
	...
	$(document).ready(function () {
		...
		function Load_book_text(defaultOption) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('Book_Issue/get_Book_data_By_ID')?>",
				dataType: "JSON",
		...
		function Load_Member_text(id) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('Book_Issue/get_Members_data_By_ID')?>",
				dataType: "JSON",
				data: {id: id},
				success: function (data) {
		...
		function get_Book_Members_List() {
			...
			$.ajax({
				type: "get",
				url: "<?php echo site_url('Book_Issue/get_Book_Members_List')?>",
				dataType: "JSON",
				success: function (data) {
					var members_html = '';
					var books_html = '';
		...
		$('#book_issue_form').on('submit', function () {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('Book_Issue/save')?>",
